  ...
  if ($("#slider_1").length) {
    ...
    $("#slider_1")
      ...
      .each(function () {
        ...
        $this.find(".slide-bg").attr("style", "background-image:" + bg_img + "; background-position: center center; background-repeat: no-repeat; background-attachment: inherit; background-size: cover; overflow:hidden;")
      })
